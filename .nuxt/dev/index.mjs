...
import { DeprecationsPlugin } from 'file://C:/Users/ET/Documents/Planting/node_modules/unhead/dist/legacy.mjs';
import { PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://C:/Users/ET/Documents/Planting/node_modules/unhead/dist/plugins.mjs';
import { klona } from 'file://C:/Users/ET/Documents/Planting/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/ET/Documents/Planting/node_modules/defu/dist/defu.mjs';
import destr, { destr as destr$1 } from 'file://C:/Users/ET/Documents/Planting/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/ET/Documents/Planting/node_modules/scule/dist/index.mjs';
import { defineDiagnostics, createConsoleReporter } from 'file://C:/Users/ET/Documents/Planting/node_modules/nostics/dist/index.mjs';
import { ansiFormatter } from 'file://C:/Users/ET/Documents/Planting/node_modules/nostics/dist/formatters/ansi.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/Users/ET/Documents/Planting/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { renderToString } from 'file://C:/Users/ET/Documents/Planting/node_modules/vue/server-renderer/index.mjs';
import { stringify, uneval } from 'file://C:/Users/ET/Documents/Planting/node_modules/devalue/index.js';
import { createHooks } from 'file://C:/Users/ET/Documents/Planting/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/Users/ET/Documents/Planting/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/Users/ET/Documents/Planting/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/ET/Documents/Planting/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/ET/Documents/Planting/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file://C:/Users/ET/Documents/Planting/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/ET/Documents/Planting/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://C:/Users/ET/Documents/Planting/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/Users/ET/Documents/Planting/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/Users/ET/Documents/Planting/node_modules/nitropack/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/Users/ET/Documents/Planting/node_modules/nitropack/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/Users/ET/Documents/Planting/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/ET/Documents/Planting/node_modules/errx/dist/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file://C:/Users/ET/Documents/Planting/node_modules/nuxt/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://C:/Users/ET/Documents/Planting/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://C:/Users/ET/Documents/Planting/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/Users/ET/Documents/Planting/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/ET/Documents/Planting","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/ET/Documents/Planting/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/ET/Documents/Planting/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/ET/Documents/Planting/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/Users/ET/Documents/Planting/.data/kv"}));
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"A joyful plant-growing tap race for teams and events."}],"link":[],"style":[],"script":[],"noscript":[],"title":"Bloom Rush — Tap, Water, Grow!"};
...
const rootDir = "C:/Users/ET/Documents/Planting";
...
const assets = {
  "/index.mjs": {
    ...
    "etag": "\"1d512-ErMf0OoZSh7YzXCzA82XCDOpCXw\"",
    "mtime": "2026-09-04T04:19:52.003Z",
    "size": 120082,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"769f1-KE8SqfwVqmkAofNE69hP2VImC9I\"",
    "mtime": "2026-09-04T04:19:52.002Z",
    "size": 485873,
    "path": "index.mjs.map"
  }
};
...
const _YfNgwB = eventHandler((event) => {
...
async function handleRoom(store, request, now = Date.now) {
...
const room = defineEventHandler(async (event) => {
  ...
  try {
    return await handleRoom(getStore({ name: "bloom-rush-rooms", consistency: "strong" }), {
      method: event.method,
      room: (_a = query.room) != null ? _a : "sprout",
      view: (_b = query.view) != null ? _b : "player",
      id: query.id,
      body: event.method === "POST" ? await readBody(event) : void 0
    });
  } catch (error) {
